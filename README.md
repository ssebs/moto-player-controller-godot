...
- [ ] fix rotation on bike mesh from resource (dirtbike is backwards)
  - [ ] see mesh_container.rotation_degrees = bike_config.mesh_rotation in @bike_mesh and @bike_config
